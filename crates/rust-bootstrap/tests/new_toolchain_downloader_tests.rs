...
mod tests {
    ...
    #[test]
    fn test_download_and_setup_toolchain_placeholder_new() {
        ...
        let rust_root = PathBuf::from("target/new_test_toolchain_downloader/rust_root");
        let build_dir = PathBuf::from("target/new_test_toolchain_downloader/build_dir");
        ...
        // fs::remove_dir_all("target/new_test_toolchain_downloader").ok();
    }
}
