...
mod tests {
    ...
    #[test]
    fn test_download_and_setup_toolchain_placeholder_v3() {
        ...
        let rust_root = PathBuf::from("target/new_test_toolchain_downloader_v3/rust_root");
        let build_dir = PathBuf::from("target/new_test_toolchain_downloader_v3/build_dir");
        ...
        // fs::remove_dir_all("target/new_test_toolchain_downloader_v3").ok();
    }
}
