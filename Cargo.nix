...
let
  nixifiedLockHash = "0a489396c3a4cd60dc30ae454a488d164d06337e80a41e6e66bd0f06aa8387a8";
...
if !lockHashIgnored && (nixifiedLockHash != currentLockHash) then
  ...
  let
    ...
    profilesByName = {
      dev = builtins.fromTOML "[package.test-float-parse]\nopt-level = 3\n";
      release = builtins.fromTOML "[package.lld-wrapper]\ndebug = 0\nstrip = true\n\n[package.rustc-rayon-core]\noverflow-checks = false\n\n[package.test-float-parse]\ncodegen-units = 1\nopt-level = 3\n\n[package.wasm-component-ld-wrapper]\ndebug = 0\nstrip = true\n";
    };
