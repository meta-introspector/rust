...
// SOURCE: library/stdarch/examples/hex.rs

// @transform(id=REMOVE_UNUSED, desc="Remove unused private items", applied=false)
// @transform(id=REMOVE_TESTS, desc="Remove test code and test modules", applied=false)
// @transform(id=REMOVE_PLATFORM, desc="Remove platform-specific AST items", applied=false)
// @transform(id=JOBSERVER_IMPORTS, desc="Fix jobserver import references", applied=false)
// @transform(id=BOOTSTRAP_FEATURES, desc="Add compiler bootstrap feature flags", applied=true)
#![feature(array_windows)]
#![feature(core_io_borrowed_buf)]
#![feature(if_let_guard)]
#![feature(staged_api)]
#![feature(rustc_private)]
// @transform(id=ADD_IMPORT_SEMANTIC, desc="Add import: std::collections::HashMap", applied=false)
// @transform(id=ADD_IMPORT_SEMANTIC, desc="Add import: rustc_index::newtype_index", applied=false)
