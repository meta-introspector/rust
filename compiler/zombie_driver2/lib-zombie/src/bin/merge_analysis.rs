...
fn find_analysis_files_recursive(dir: &str, files: &mut Vec<String>) -> Result<(), Box<dyn std::error::Error>> {
...
fn merge_analysis_file(file_path: &str, merged: &mut MergedAnalysis) -> Result<(), Box<dyn std::error::Error>> {
    ...
    merged.file_analyses.insert(file_name, FileAnalysis {
