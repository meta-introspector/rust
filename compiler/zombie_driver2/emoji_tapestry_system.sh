...
echo "🎨 EMOJI TAPESTRY GENERATOR FOR RUST CODE"
echo "========================================="
echo "Creating visual representations of code character at multiple scales!"
echo ""

# Create emoji tapestry generator
cat > generate_emoji_tapestry.sh << 'EOF'
#!/bin/bash
...
chmod +x generate_emoji_tapestry.sh

# Create multi-scale tapestry generator
cat > generate_all_tapestries.sh << 'EOF'
#!/bin/bash
...
chmod +x generate_all_tapestries.sh

echo "✅ Emoji tapestry generators created!"
echo ""
echo "🎨 TESTING WITH TUTORIAL SAMPLE..."
echo "================================="

# Test with our tutorial sample
./generate_emoji_tapestry.sh results_tutorial_demo_rustc_chunk_01.json 8

echo ""
echo "🎯 USAGE EXAMPLES:"
echo "=================="
echo ""
echo "📱 Generate single tapestry:"
echo "   ./generate_emoji_tapestry.sh results_file.json 16"
echo ""
echo "🖼️ Generate all scales (2x2 to 256x256):"
echo "   ./generate_all_tapestries.sh results_file.json"
echo ""
echo "🎨 Available scales: 2, 4, 8, 16, 32, 64, 128, 256"
echo ""
echo "✨ Each tapestry preserves the mathematical character of the code!"
